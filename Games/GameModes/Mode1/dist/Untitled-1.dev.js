...
console.log(quokka); // See the value of a variable simply by typing its name
...
quokka, wallaby; // Gutter indicators show what code was executed (code coverage)
// Orange indicators means only part of the line was executed
// because JavaScript stops processing after first false value

console.log('partialCoverage', false && true); // Green indicators means that Quokka executed all statements
// on a line of code
...
throw new Error('Something went wrong'); // There's a lot more Quokka can do! Visit our docs to learn more:
